...
void definition_def::typecheck_first(type_mgr &mgr, type_env &env)
{
...
void definition_def::typecheck_second(type_mgr &mgr, const type_env &env) const
{
...
void definition_comment::typecheck_first(type_mgr &mgr, type_env &env)
{
    // Nothing
}

void definition_comment::typecheck_second(type_mgr &mgr, const type_env &env) const
{
    // Nothing
}
